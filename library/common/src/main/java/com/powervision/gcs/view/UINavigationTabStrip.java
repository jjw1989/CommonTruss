...
/**
 * 顶部指示器
 * Created by Sundy on 2017/9/15.
 */
@SuppressWarnings("unused")
public class UINavigationTabStrip extends View implements ViewPager.OnPageChangeListener {
    ...
    public UINavigationTabStrip(final Context context) {
        this(context, null);
    }

    public UINavigationTabStrip(final Context context, final AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public UINavigationTabStrip(final Context context, final AttributeSet attrs, final int defStyleAttr) {
