...
import com.powervision.gcs.network.AddCookiesInterceptor;
import com.powervision.gcs.network.BaseApiService;
import com.powervision.gcs.network.BaseInterceptor;
import com.powervision.gcs.network.BaseResponse;
import com.powervision.gcs.network.CacheInterceptor;
import com.powervision.gcs.network.CallBack;
import com.powervision.gcs.network.DownLoadManager;
import com.powervision.gcs.network.ExceptionHandle;
import com.powervision.gcs.network.NovateCookieManger;
import com.powervision.gcs.network.ReceivedCookiesInterceptor;
...
public class RetrofitClient {
    ...
    //默认为正式库
    public static final String Base_URL = "http://api.powervision.me";
    ...
    public RetrofitClient createBaseApi() {
        ...
        apiAdService=create(ApiAdService.class);
        return this;
    }
    ...
    public Flowable getAdInfo(String url,Map<String,String> parameters){
        return apiAdService.getAdInfo(url,parameters)
                .compose(schedulersTransformer())
                .compose(transformer());
    }
    ...
    public  <T> Flowable<T> switchSchedulersMain(Flowable<T> observable) {
        return observable.subscribeOn(Schedulers.io())
                .unsubscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread());
    }
